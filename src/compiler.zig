...
pub const Parser = struct {
    ...
    const rules = [_]ParseRule{
        ...
        .{ .prefix = null, .infix = null, .precedence = .none }, //more,
        .{ .prefix = null, .infix = null, .precedence = .none }, //more_equal,
        ...
        .{ .prefix = null, .infix = null, .precedence = .none }, //false_,
        ...
        .{ .prefix = null, .infix = null, .precedence = .none }, //true_,
